...
console.log(randomFrage);

function createQuestion() {
  // create question
  const question = document.createElement("h1");
  const questionText = document.createTextNode(randomFrage.frage);
...
function createButtons(question) {
  ...
  randomFrage.antworten.forEach((antwort) => {
  ...
  displayQuestion(question, buttonsDiv);
}

function displayQuestion(question, button) {
